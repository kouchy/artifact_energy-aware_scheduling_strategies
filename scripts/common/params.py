...
path_schedulings    = "./input/schedulings/"
path_raw            = "./input/throughput/"
path_conso_raw      = "./input/conso_socket/"
path_conso_rapl_raw = "./input/conso_rapl/"
path_postpro        = "./output/1_postpro/"
path_conso_postpro  = "./output/2_postpro_with_conso/"
